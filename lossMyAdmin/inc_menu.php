...
$menu=array (
	...
	'webhelper'=>array (
		...
		4=>"",
		5=>"<a target='I2' href='admin_playhistory.php?ac=list'>播放记录管理</a>",
		6=>"<a target='I2' href='admin_members.php?ac=list'>注册用户管理</a>",
		7=>"<a target='I2' href='admin_members_group.php'>用户组管理</a>",
		8=>"<a target='I2' href='admin_card.php'>充值卡生成</a>",
		9=>"<a target='I2' href='admin_card_list.php'>充值卡列表</a>",
		10=>"<a target='I2' href='admin_config_ucenter.php'>Ucenter设置</a>",
		11=>"",
		12=>"<a target='I2' href='admin_ads.php?action=main'>广告管理</a>",
		13=>"<a target='I2' href='admin_ads.php?action=add'>添加广告</a>",
		14=>"<a target='I2' href='admin_slide.php'>幻灯片管理</a>",
		15=>"",
		16=>"<a target='I2' href='admin_link.php'>友情链接</a>",
	),
	'webyun'=>array (
